...
class AccountInvoiceReportWizard(models.TransientModel):
    ...
    def generate_excel(self, invoices):
        ...
        for inv in invoices:
            ...
            total = getattr(inv, 'total', inv.amount_untaxed_in_currency_signed if inv.move_type== 'out_invoice' else inv.amount_untaxed_in_currency_signed*-1)
            ...
            sheet.write(row, 13, inv.amount_total_in_currency_signed if inv.move_type== 'out_invoice' else  inv.amount_total_in_currency_signed*-1 , line_format)
