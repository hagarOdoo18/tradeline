...
class ShopifySync(models.Model):
    ...
    product_prod_id = fields.Many2one('product.product', string='Product',
                                      help='Id of the product in product'
                                           ' product')
    ...
    shopify_order_name = fields.Char(string='Name', readonly=True,
                                     store=True, help='Order name in shopify')
    shopify_order_number = fields.Char(string='Order No', readonly=True,
                                       store=True,
    ...
    last_order_id = fields.Char(string='Last order id', readonly=True,
