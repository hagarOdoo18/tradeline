    ...
    def action_export_excel(self):
        ...
        if self.env.user.has_group('export_invoice_move_line.group_export_invoice_move_line_admin'):
            ...
            for line in invoice_lines:
                ...
                sheet.write(row, 18, line.discount_reason_id.name or 0)
            ...
            for line in invoice_lines:
                ...
                sheet.write(row, 24, line.discount_reason_id.name or 0)
            ...
            for line in invoice_lines:
                ...
                sheet.write(row, 17, line.discount_reason_id.name or 0)
