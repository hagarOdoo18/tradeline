...
class ExportInvoiceMoveLineWizard(models.TransientModel):
    ...
    def action_export_excel(self):
        domain = [
            ('move_id.move_type', 'in', ['out_invoice','out_refund']), ('move_id.payment_state', 'in', ('paid', 'partial','in_payment')),
        ...
        if self.env.user.has_group('export_invoice_move_line.group_export_invoice_move_line_admin'):
            ...
            for line in invoice_lines:
                ...
                sheet.write(row, 13, line.quantity or '')
                ...
                sheet.write(row, 19, float(line.product_id.standard_price * line.quantity) or 0)
            ...
            for line in invoice_lines:
                ...
                sheet.write(row, 17, amount_untaxed_signed or '')
                sheet.write(row, 18, amount_total_signed or '')
                sheet.write(row, 19, payment_journals or '')
                sheet.write(row, 20, payment_amount or '')
