...
class ResCompany(models.Model):
    ...
    eamil_to_branch_template_id_admin = fields.Many2one(
        'mail.template', string='Admin Email To Branch Template (New Order)')
    eamil_to_agent_won_template_id_admin = fields.Many2one(
        'mail.template', string='Admin Email To Agent Template (Won)')
    eamil_to_agent_lost_template_id_admin = fields.Many2one(
        'mail.template', string='Admin Email To Agent Template (Lost)')
    eamil_to_agent_canceled_template_id_admin = fields.Many2one(
        'mail.template', string='Admin Email To Agent Template (Cancelled)')
    eamil_to_branch_canceled_template_id_admin = fields.Many2one(
        'mail.template', string='Admin Email To Branch Template (Cancelled)')
    eamil_to_agent_refunded_template_id_admin = fields.Many2one(
        'mail.template', string='Admin Email To Agent Template (Refunded)')
class HelpdeskSettings(models.TransientModel):
    ...
    eamil_to_branch_template_id_admin = fields.Many2one(
        'mail.template', string='Admin Email To Branch Template (New Order)', related='company_id.eamil_to_branch_template_id_admin', readonly=False)
    eamil_to_agent_won_template_id_admin = fields.Many2one(
        'mail.template', string='Admin Email To Agent Template (Won)', related='company_id.eamil_to_agent_won_template_id_admin', readonly=False)
    eamil_to_agent_lost_template_id_admin = fields.Many2one(
        'mail.template', string='Admin Email To Agent Template (Lost)', related='company_id.eamil_to_agent_lost_template_id_admin', readonly=False)
    eamil_to_agent_canceled_template_id_admin = fields.Many2one(
        'mail.template', string='Admin Email To Agent Template (Cancelled)', related='company_id.eamil_to_agent_canceled_template_id_admin', readonly=False)
    eamil_to_branch_canceled_template_id_admin = fields.Many2one(
        'mail.template', string='Admin Email To Branch Template (Cancelled)', related='company_id.eamil_to_branch_canceled_template_id_admin', readonly=False)
    eamil_to_agent_refunded_template_id_admin = fields.Many2one(
        'mail.template', string='Admin Email To Agent Template (Refunded)', related='company_id.eamil_to_agent_refunded_template_id_admin', readonly=False)
